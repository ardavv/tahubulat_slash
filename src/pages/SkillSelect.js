...
function Skill() {
    ...
    return (
        <div className={styles.container} style={{ margin: 'auto 100px' }}>
            <div className={styles.header} style={{ backgroundColor: 'white', borderRadius: '20px', height: '70px', maxWidth: '500px', margin: '50px auto' }}>
                <h1 style={{ textAlign: 'center', marginTop: '10px', fontWeight: 'bolder' }}>
                    Choose Your Skill Level
                </h1>
            </div>

            <Row xs={1} md={3} className="g-0" style={{ display: 'flex', justifyContent: 'center' }}>
