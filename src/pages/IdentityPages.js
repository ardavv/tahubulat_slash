...
import styles from '../style/homeIdentity.module.css';
...
function Identity() {
    ...
    return (
        <div className={styles.container} style={{ maxWidth: '420px', margin: '100px auto' }}>
            <div className={styles.profile} style={{ backgroundColor: 'white', borderRadius: '25px', width: '500px', border: '1px solid black' }}>
                <div className="container">
                    ...
                    <div className={styles.next} style={{ textAlign: 'center' }}>
